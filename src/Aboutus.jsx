        ...
        <div className="container mb-3">
            <div className="row">
                ...
                our-service-leftside-img">
                    <img src="./images/hero3.jpg" alt="Abotuus" />
                </div>
     {/* rightside section */}
      <div className="col-10 col-lg-7 our-services-list">
       ...
       <section className="common-section our-services
        ...
        <div className="container mb-5">
          <div className="row">
            ...
            our-services-rightside-content d-flex justify-content-center align-items-start flex-column">
